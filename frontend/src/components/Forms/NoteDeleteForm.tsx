...
export const NoteDeleteForm = ({setOpenForm, noteId, groupId, fetchOnChange}: Props) => {
  ...
  return (
    <div className="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      ...
      {showSuccessModal && 
      <ModalSuccess title="Borrado con éxito" description="Se ha borrado la nota exitosamente" route={`/grupo/${groupId}`} button="Volver" onClose={handleCloseAll}/>
      }
    </div>
  )
}
